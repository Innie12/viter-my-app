    ...
    <>
      ...
      >
        <span
          ...
          } -right-3 top-1 cursor-pointer bg-white h-[23px] w-[23px] rounded-full inline-flex items-center justify-center shadow-md group hover:bg-dashboard translation-all ease-in-out duration-200`}
        >
          <IndentDecrease
            onClick={toggleSideNav}
